...
<title>Sesi Kedaluwarsa | Kas RT 10</title>
<link href="https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500;9..40,600&display=swap" rel="stylesheet">
<style>
:root{
  --cream:#F3EDD8;--warm:#FDFAF2;
  --forest:#1A3D2B;--forest-mid:#2A5C40;--forest-pale:#EBF3EE;
  --gold:#C8A030;--gold-pale:#FBF3DC;
  --ink:#1A1810;--ink-soft:#6B6050;
...
<div class="wrap">
  ...
  <p>Token sesi kamu sudah tidak valid karena halaman terlalu lama dibuka.<br>Muat ulang halaman untuk melanjutkan.</p>
  <a href="javascript:location.reload()" class="btn-primary">Muat Ulang Halaman</a>
</div>
</body>
</html>
